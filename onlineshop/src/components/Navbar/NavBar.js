        ...
        <Link className="text" to="/"> <button className="btn navbar-brand logo" >OnlineShop</button></Link>
          ...
          <div className="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
            <div className="navbar-nav justify-content-end aa">
              ...
              <NavLink className="text" to="/category/:id" activeClassName="active"><button className="btn nav-link" >REMERAS</button></NavLink>
              <NavLink className="text" to="/category/:id" activeClassName="active"><button className="btn nav-link " >CAMPERAS</button></NavLink>
              <NavLink className="text" to="/category/:id" activeClassName="active"><button className="btn nav-link" >ZAPATILLAS</button></NavLink>
              <CartWidget/>
            </div>
          </div>
        </div>
